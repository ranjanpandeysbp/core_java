...
public class CountWords1 {
    public static void main(String[] args)
    {
        ...
        //String sentence = "              How   are     you?              huh bol ";
        //String sentence = "How    are you? huh bol ";
        ...
        {
            sentence = sentence.replaceAll("[\\h\\s\\v]+"," ");
            System.out.println("Input String without any whitespaces except single space between words is: \""+sentence+"\"");
